...
const testAuth = async () => {
    try {
        ...
        try {
            ...
            if (!registerRes.data.data.token) console.error('❌ Token missing in registration response');
        } catch (error: any) {
        ...
        try {
            ...
            if (!loginRes.data.data.token) console.error('❌ Token missing in login response');
        } catch (error: any) {
