...
export class AuthService {
    ...
    async register(data: { name: string; email: string; phoneNumber: string; password: string }): Promise<{ user: User; token: string }> {
    ...
    async login(data: { phoneNumber: string; password: string }): Promise<{ user: User; token: string }> {
