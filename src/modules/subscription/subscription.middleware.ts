...
export const requireActiveSubscriptionForConsultation = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const requireActiveSubscriptionForMessage = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
